...
public class AnnotationImpl extends EObjectImpl implements Annotation {
	 ...
	 * @ordered
	 */
	protected static final AnnotationType TYPE_EDEFAULT = AnnotationType.OVERRIDE;
	 ...
	 * @ordered
	 */
	protected EList<KeyValuePair> parameters;
	...
	protected EClass eStaticClass() {
		return ConcretesyntaxPackage.Literals.ANNOTATION;
	}
	...
	public void setType(AnnotationType newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConcretesyntaxPackage.ANNOTATION__TYPE, oldType, type));
	}
	...
	public EList<KeyValuePair> getParameters() {
		if (parameters == null) {
			parameters = new EObjectContainmentEList<KeyValuePair>(KeyValuePair.class, this, ConcretesyntaxPackage.ANNOTATION__PARAMETERS);
		}
		return parameters;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ConcretesyntaxPackage.ANNOTATION__PARAMETERS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ConcretesyntaxPackage.ANNOTATION__TYPE:
				return getType();
			case ConcretesyntaxPackage.ANNOTATION__PARAMETERS:
