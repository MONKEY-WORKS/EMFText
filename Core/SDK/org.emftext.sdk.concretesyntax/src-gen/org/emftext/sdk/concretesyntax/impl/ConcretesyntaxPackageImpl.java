...
public class ConcretesyntaxPackageImpl extends EPackageImpl implements ConcretesyntaxPackage {
	...
	public void initializePackageContents() {
		...
		addEEnumLiteral(optionTypesEEnum, OptionTypes.OVERRIDE_IGNORED_WORDS_FILTER);
		addEEnumLiteral(optionTypesEEnum, OptionTypes.OVERRIDE_TASK_ITEM_DETECTOR);
		addEEnumLiteral(optionTypesEEnum, OptionTypes.OVERRIDE_TASK_ITEM_BUILDER);
		addEEnumLiteral(optionTypesEEnum, OptionTypes.OVERRIDE_SOURCE_VIEWER_CONFIGURATION);
		addEEnumLiteral(optionTypesEEnum, OptionTypes.OVERRIDE_TASK_ITEM);
	...
	protected void createGenModelAnnotations() {
		...
		addAnnotation
		  (optionTypesEEnum.getELiterals().get(278), 
		   source, 
		   new String[] {
		...
		addAnnotation
		  (optionTypesEEnum.getELiterals().get(288), 
		   source, 
		   new String[] {
		...
		addAnnotation
		  (optionTypesEEnum.getELiterals().get(292), 
		   source, 
		   new String[] {
		...
		addAnnotation
		  (optionTypesEEnum.getELiterals().get(294), 
		   source, 
		   new String[] {
			 "documentation", "If set to <code>false</code>, the ITokenScanner interface will not be overridden. The default value for this option is <code>true</code>."
		   });	
		addAnnotation
		  (optionTypesEEnum.getELiterals().get(295), 
		   source, 
		   new String[] {
		...
		addAnnotation
		  (optionTypesEEnum.getELiterals().get(297), 
		   source, 
		   new String[] {
		...
		addAnnotation
		  (optionTypesEEnum.getELiterals().get(303), 
		   source, 
		   new String[] {
		...
		addAnnotation
		  (optionTypesEEnum.getELiterals().get(307), 
		   source, 
		   new String[] {
		...
		addAnnotation
		  (optionTypesEEnum.getELiterals().get(309), 
		   source, 
		   new String[] {
