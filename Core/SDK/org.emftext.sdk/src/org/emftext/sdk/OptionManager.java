...
public class OptionManager {
	...
	private void initializeOptionLists() {
		...
		STRING_OPTIONS.add(OptionTypes.ADDITIONAL_IMPORTED_PACKAGES);
		STRING_OPTIONS.add(OptionTypes.ADDITIONAL_UI_IMPORTED_PACKAGES);
		STRING_OPTIONS.add(OptionTypes.ADDITIONAL_LIBRARIES);
		...
		STRING_OPTIONS.add(OptionTypes.REFERENCED_RESOURCE_EXTENSIONS);
