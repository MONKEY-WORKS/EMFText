		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Terminal_feature_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Terminal_feature_feature", "_UI_Terminal_type"),
				 ConcretesyntaxPackage.Literals.TERMINAL__FEATURE,
				 true,
				 false,
				 true,
				 null,
