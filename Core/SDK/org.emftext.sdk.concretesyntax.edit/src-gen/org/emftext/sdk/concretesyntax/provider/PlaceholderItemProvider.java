...
public class PlaceholderItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Placeholder_token_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Placeholder_token_feature", "_UI_Placeholder_type"),
				 ConcretesyntaxPackage.Literals.PLACEHOLDER__TOKEN,
				 true,
				 false,
				 true,
				 null,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Placeholder.class)) {
			case ConcretesyntaxPackage.PLACEHOLDER__CARDINALITY:
