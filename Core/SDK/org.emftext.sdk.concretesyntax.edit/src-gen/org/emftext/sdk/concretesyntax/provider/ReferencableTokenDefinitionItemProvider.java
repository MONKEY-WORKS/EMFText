...
/**
 * This is the item provider adapter for a {@link org.emftext.sdk.concretesyntax.ReferencableTokenDefinition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ReferencableTokenDefinitionItemProvider
	 ...
	 * @generated
	 */
	public ReferencableTokenDefinitionItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((ReferencableTokenDefinition)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_ReferencableTokenDefinition_type") :
			getString("_UI_ReferencableTokenDefinition_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ReferencableTokenDefinition.class)) {
